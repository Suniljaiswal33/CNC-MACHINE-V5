    ...
    with BuildSketch(Plane.XY):
        ...
        while y < ymax:
            ...
            while x < xmax:
                ...
                if all(inside(px, py, points) for px, py in hex_pts):
                    Polygon(hex_pts)
...
scaled = part.part.translate((-cx, -cy, -cz))
scaled = scaled.scale(0.099)
scaled = scaled.translate((cx, cy, cz))

# =========================
# EXPORT
# =========================
export_stl(scaled, stl_path)

print("✅ SCALED STL GENERATED:", stl_path)
